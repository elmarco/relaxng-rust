...
use super::{Result, genenum::GenEnumRef, genmod::GenLib, genstruct::GenStruct};
...
impl GenUnit {
    pub(crate) fn name(&self) -> String {
        match self {
            GenUnit::Lib(m) => m.name().to_string(),
    ...
    pub(crate) fn mod_name(&self) -> String {
        ...
        match self {
            GenUnit::Lib(m) => m.name().to_snake_case(),
    ...
    pub(crate) fn token_stream(&self) -> TokenStream {
        match self {
            GenUnit::Lib(m) => m.to_token_stream(),
...
pub(crate) struct GenTree {
    ...
    pub(crate) children: IndexMap<String, GenTree>,
